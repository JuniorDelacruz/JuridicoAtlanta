...
import { ArrowLeft, Scale, Search as SearchIcon, Webhook, Shield, ShieldCheck, Crown } from "lucide-react";
...
function SubRoleBadge({ subRole }) {
    const v = (subRole ?? "").toString().trim().toLowerCase();
    ...
    // fallback p/ qualquer outro subRole
    return (
