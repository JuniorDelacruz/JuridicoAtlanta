// frontend/src/pages/TriagemRequerimentoDetalhes.jsx
...
export default function TriagemRequerimentoDetalhes() {
  ...
  // ✅ config da triagem (tem "carimbo")
  const triagemCfg = getTriagemTipoBySlug(slug);

  // ✅ tipo real do requerimento para exibir campos
  const reqTipoSlug = slug === "carimbo" ? "Porte de Arma" : slug;
  const reqTipoCfg = getTipoBySlug(reqTipoSlug);
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        // ✅ validação do tipo: no carimbo, o tipo real é "Porte de Arma"
        const expectedTipo = slug === "carimbo" ? "Porte de Arma" : triagemCfg.tipoDb;
  ...
  // ✅ campos do tipo REAL do requerimento (Porte de Arma quando slug=carimbo)
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold">
              Triagem — Detalhes ({triagemCfg?.label || "Requerimento"})
            </h1>
          </div>
