// frontend/src/pages/TriagemRequerimentoDetalhesCasamento.jsx
...
function CartorioCard({ title, cidadao }) {
  return (
...
export default function TriagemRequerimentoDetalhesCasamento() {
  ...
  const pessoas = useMemo(
    () => [
      ...
      { key: "cidadaoNoiva", label: "Noiva", value: dados?.cidadaoNoiva || null },
      { key: "cidadaoTest1", label: "Testemunha 1", value: dados?.cidadaoTest1 || null },
      { key: "cidadaoTest2", label: "Testemunha 2", value: dados?.cidadaoTest2 || null },
      { key: "cidadaoTest3", label: "Testemunha 3", value: dados?.cidadaoTest3 || null },
    ],
    [dados]
  );
      ...
      <header className="bg-blue-900 text-white py-4 px-6 shadow-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold">Triagem — Detalhes (Casamento)</h1>
          </div>
              ...
              <div className="p-6 border-b flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                <div>
                  <h2 className="text-2xl font-bold text-gray-800">
                    Requerimento #{data.numero} — {triagemCfg?.label || data.tipo}
                  </h2>
              ...
              <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white border rounded-lg p-5 lg:col-span-2">
                  ...
                  {camposDoTipo.length ? (
                    ...
                    <div className="text-gray-600 text-sm">
                      Não há configuração de campos para este tipo. Vou exibir o JSON abaixo.
                    </div>
                  )}
                ...
                <div className="bg-white border rounded-lg p-5 lg:col-span-3">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    {pessoas.map((p) => (
                      <CartorioCard key={p.key} title={p.label} cidadao={p.value} />
                    ))}
                  </div>
                  ...
                  <p className="text-xs text-gray-500 mt-4">
                    * Esses dados vêm de <span className="font-mono">dados.cidadaoNoivo</span>,{" "}
                    ...
                    <span className="font-mono">dados.cidadaoTest3</span>.
                  </p>
                </div>
              </div>
            </div>
