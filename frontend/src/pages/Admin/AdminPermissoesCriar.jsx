// src/pages/admin/AdminPermissoesCriar.jsx (ou onde você organiza as páginas)
...
export default function AdminPermissoesCriar() {
  const { push } = useToast();
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <div className="flex items-center gap-4">
            <div className="p-3 bg-indigo-100 rounded-xl">
              <PlusCircle className="h-10 w-10 text-indigo-700" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Criar Nova Permissão</h1>
              <p className="mt-1.5 text-base text-gray-600">
                Adicione uma nova permissão granular ao sistema
              </p>
            </div>
          </div>
          ...
          >
            <ArrowLeft size={18} />
            Voltar ao Centro de Permissões
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow border border-gray-200 overflow-hidden">
          ...
          <div className="p-7">
            ...
            <div className="mt-6 flex items-center gap-3 text-sm text-gray-600">
              <span>Permissões já cadastradas:</span>
