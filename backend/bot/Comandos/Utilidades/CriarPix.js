...
const PIX_KEY = process.env.PIX_KEY || "trindatrindak@gmail.com";
const MERCHANT_NAME = process.env.PIX_MERCHANT_NAME || "Trinda Boost";
const MERCHANT_CITY = process.env.PIX_MERCHANT_CITY || "Sao Paulo";
...
async function makePixQrWithGuildIcon(payload, iconUrl) {
...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    const btnEnviar = new Discord.ButtonBuilder()
      .setCustomId(`pix_send:${interaction.id}`)
      .setLabel("Enviar Pix")
      .setEmoji("💠")
      .setStyle(Discord.ButtonStyle.Success);

    const btnCancelar = new Discord.ButtonBuilder()
      .setCustomId(`pix_cancel:${interaction.id}`)
      .setLabel("Cancelar")
      .setEmoji("✖️")
